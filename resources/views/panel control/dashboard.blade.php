                                        ...
                                        @isset($movies)
                                            @forelse($movies as $movie)
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <button type="button" class="btn btn-sm btn-outline-danger mr-1 favorite-btn"
                                                            data-imdb="{{ $movie['imdbID'] ?? '' }}"
                                                            data-title="{{ $movie['Title'] ?? '' }}"
                                                            data-year="{{ $movie['Year'] ?? '' }}"
                                                            data-poster="{{ isset($movie['Poster']) && $movie['Poster'] !== 'N/A' ? $movie['Poster'] : 'https://via.placeholder.com/50x70?text=No+Image' }}"
